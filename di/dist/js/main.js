    ...
    $('[data-overlay-color]').each(function () {
        ...
        if ($(this).find('.overlay').length === 0) {
            if($(this).data("overlay-image")){
                var bgStyle = 'background: ' + $(this).data("overlay-color") + ' url(' + $(this).data("overlay-image") + ') no-repeat center center fixed; background-size: cover; background-blend-mode: saturation;';
            }else{
